...
class PhongShadingDemoShaderProg : public ShaderProg {
 public:
  ...
  GLint GetLocOnPointLight() const { return locOnPointLight; }
  GLint GetLocOnSpotLight() const { return locOnSpotLight; }
  GLint GetLocOnDirLight() const { return locOnDirLight; }
 ...
 private:
  ...
  GLint locOnPointLight;
  GLint locOnSpotLight;
  GLint locOnDirLight;
